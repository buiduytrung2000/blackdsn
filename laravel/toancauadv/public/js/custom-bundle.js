...
(function ($) {
    ...
    window.addEventListener("DOMContentLoaded", function () {
      ...
      tl.to(present, 1, {
        ...
        .fromTo(
          ...
          1,
          { y: 400 },
          { y: 0, clearProps: true, ease: Expo.easeInOut },
          "-=1.2"
        )
        .call(function () {
          preloader.remove();
  ...
  function menuInit() {
    ...
    const TransEnd = () =>
      reserved.getValue() &&
      menu.querySelector(".primary-nav")?.classList.add("open");
    ...
    new Promise((resolve) => setTimeout(() => resolve(), 300))
      .then(() =>
        dsnGrid.spltting.Char(targets.toggle?.querySelector(".text-menu"))
      )
      .then(() =>
        dsnGrid.spltting.Char(targets.toggle?.querySelector(".text-open"))
      )
      .then(() =>
        dsnGrid.spltting.Char(targets.toggle?.querySelector(".text-close"))
      )
      .then(() => {
      ...
      if (window.innerWidth > 575) {
        navContainer.querySelectorAll("h6.sm-title-block").forEach(($item) => {
          ...
          s.chars.forEach(($item, $index) => {
            ...
            $item.setAttribute("data-swiper-parallax-duration", $index * 50);
            ...
            if (s.chars.length === $index - 4) {
              ...
              arrow.setAttribute("data-swiper-parallax-duration", $index * 50);
